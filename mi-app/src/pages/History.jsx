  ...
  return (
    <div className="max-w-2xl mx-auto text-white mt-10">
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 shadow-xl text-center space-y-5">
        <h3 className="text-xl font-bold text-white">Módulo: Historial de Operaciones</h3>
        ...
        <p className="text-sm text-slate-400 leading-relaxed">
          En el Plazo 3 se añadirá la bitácora de auditoría detallada en la que se registrará el momento exacto, la cantidad, el motivo y la cuenta del colaborador que realizó cualquier movimiento físico en el almacén.
        </p>
      </div>
    </div>
  );
