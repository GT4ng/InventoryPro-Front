  ...
  return (
    <div className="animar-aparicion">
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ fontSize: '12px', color: 'var(--color-mutado)' }}>
          Administra los accesos de los operadores y administradores de la plataforma.
        </p>
      </div>
            ...
            <div key={u.id} className="tarjeta-usuario">
              <div className="info-usuario">
                ...
                <p>
                  {u.email} · Rol:{' '}
                  <span
                    className="etiqueta etiqueta-azul"
                  ...
                  <span
                    className={`etiqueta ${
                      u.status === 'active' ? 'etiqueta-verde' : 'etiqueta-gris'
                    }`}
                    style={{ fontSize: '10px', padding: '1px 6px' }}
                  >
                    {u.status}
                ...
                <button
                  onClick={() => {
                    if (currentUser && u.id === currentUser.id)
                      return alert('No puedes desactivar tu propia cuenta.');
